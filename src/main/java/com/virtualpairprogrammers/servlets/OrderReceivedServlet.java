...
import com.virtualpairprogrammers.websockets.KitchenDisplaySessionHanlderFactory;
...
public class OrderReceivedServlet extends HttpServlet {
	...
	public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		KitchenDisplaySessionHandler hanlder = KitchenDisplaySessionHanlderFactory.getHandler();
		hanlder.newOrder(order);
